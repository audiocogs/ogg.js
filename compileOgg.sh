...
cd ..
mkdir -p build
emcc -O3 -I ogg/include -s WASM=0 -s RESERVED_FUNCTION_POINTERS=50 -s EXPORTED_FUNCTIONS="['_AVOggInit', '_AVOggRead', '_AVOggDestroy']" src/ogg.c ogg/lib/libogg.a -o build/libogg.js
